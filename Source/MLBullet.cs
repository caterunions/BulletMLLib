...
namespace BulletMLLib
{
    ...
    {
        #region Members
        public BulletMLPattern Pattern { get; private set; }
        ...
        public MLBullet(IBulletManager myBulletManager, BulletMLPattern pattern, bool top)
        {
                ...
                for (int i = 1; i < 10; i++)
                {
                    ...
                    if (topNode != null)
                    {
                        ...
                        else
                        {
                            ...
                            MLBullet newDude = _bulletManager.CreateBullet(this, Pattern, true);
